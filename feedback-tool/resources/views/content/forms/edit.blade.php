            ...
            <div class="flex">
                ...
                @if(\Illuminate\Support\Facades\Session::has('message'))
                    <div class="bg-green-50 border border-green-400 text-green-800 px-4 py-3 rounded relative" role="alert">
                        <strong class="font-bold text-green-500">{{\Illuminate\Support\Facades\Session::get('message')}}</strong>
                        <span class="block sm:inline"> {{$form->title}} has been successfully edited! </span>
